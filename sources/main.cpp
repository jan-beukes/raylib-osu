...
int main()
{
    ...
    Music music = LoadMusicStream("audio.mp3"); // Load the music file
    ...
    while (std::getline(circleFile, line))
    {
        ...
        circle.start_time = circle.max_time - 5.0f; // Appear 3 seconds before end
    ...
    float elapsed_time = 0.0f; // Add this variable to track elapsed time
    ...
    while (!WindowShouldClose())
    {
        ...
        BeginDrawing();
        {
            ...
            // Draw timer
            DrawText(TextFormat("Time: %.2f s", elapsed_time), window_width - 150, 10, 20, WHITE);
